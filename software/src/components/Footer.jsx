...
const Footer = () => {
  return (
      <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full border-t border-green-900 shadow-lg">
                       text-gray-800">
        <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-400/40 pb-6">
          ...
          <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
              ...
              turning data into insights for better productivity and sustainability.
            </p>
          </div>
          ...
          <div className="flex-1 flex items-start md:justify-end gap-20">
            ...
            <div>
              ...
              <ul className="text-sm space-y-2">
                ...
                <li><a href="#" className="hover:text-green-700">Smart Farming</a></li>
                <li><a href="#" className="hover:text-green-700">AI Insights</a></li>
                <li><a href="#" className="hover:text-green-700">IoT Dashboard</a></li>
